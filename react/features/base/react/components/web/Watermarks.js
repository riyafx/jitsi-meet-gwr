...
const _RIGHT_WATERMARK_STYLE = {
    backgroundImage: "url(images/rightwater mark.png)",
};
...
class Watermarks extends Component<Props, State> {
    ...
    _renderJitsiWatermark() {
        ...
        let reactElement = null;
        let logo1Url = "images/logo1.png";
        let logo2Url = "images/logo2.png";
        ...
        if (_showJitsiWatermark) {
            ...
            reactElement = (
                <div style={{ display: "flex" }}>
                    <div className="watermark leftwatermark" style={style1} />
                    <div className="watermark leftwatermark" style={style2} />
                </div>
            );

            if (_logoLink) {
                reactElement = (
                    <a href={_logoLink} target="_new">
                        {reactElement}
                    </a>
                );
            }
